...
{{- . }}
{{- else }}
{{- include "trustification.common.imageRegistry" . }}/{{ .image.name | default .imageName | default .defaults.name | default "trustd" }}:{{ include "trustification.common.imageVersion" . }}
{{- end }}
{{- end }}
